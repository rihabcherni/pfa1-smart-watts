...
export default function CompteurPanne() {
  ...
  return (
    <div style={{width:"100%"}}>
        <Api nom='compteur panne' tableNamePlu='compteur panne' tableNameSing='Liste compteur panne' url={url} initialValue={initialValue} columnDefs={columnDefs} show={show} createUpdate={createUpdate}/>  
    </div>
  );
}

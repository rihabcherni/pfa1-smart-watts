...
export default function ConsommationJournaliere() {
  ...
  return (
    <div style={{width:"100%"}}>
        <Api nom='consommation journaliére' tableNamePlu='consommation journaliére' tableNameSing='Liste consommation journaliére' url={url} initialValue={initialValue} columnDefs={columnDefs} show={show} createUpdate={createUpdate}/>  
    </div>
  );
}

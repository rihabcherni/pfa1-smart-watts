...
export default function Facture() {
  ...
  return (
    <div style={{width:"100%"}}>
        <Api nom='Facture' tableNamePlu='Facture' tableNameSing='Liste paiement' url={url} initialValue={initialValue} columnDefs={columnDefs} show={show} createUpdate={createUpdate}/>  
    </div>
  );
}